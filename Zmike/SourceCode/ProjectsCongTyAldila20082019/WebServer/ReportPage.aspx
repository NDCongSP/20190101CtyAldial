                          ...
                          <tr  style="background: #000000;">
                              <td colspan="2">
                                  <ul id="menu">
                                    ...
                                    <li><a href="ReportPage.aspx" style="color:white">Report</a></li>
                                                     ...
                                                     <td style="text-align: center; width:100%">
                                                        <fieldset style="border-style: groove; border-color: #00802b;border-radius: 7px;box-shadow: 5px 5px 5px #808080" >
                                                         ...
                                                         <table style="width: 100%; height: 100%">
                                                               ...
                                                               <tr style="height: 10%">
                                                                    <td style="text-align: left; width: 20%">
                                                                        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="110%" ForeColor="#00802B" Text="Part"></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left; width: 20%">
                                                                                 <asp:DropDownList ID="drplPart" runat="server" EnableTheming="True" Font-Size="110%" ForeColor="Black" Width="100%">
                                                                                 </asp:DropDownList>
                                                                    </td>
                                                                    <td style="text-align: left; width: 10%">&nbsp;</td>

                                                                    <td style="text-align: left; width: 20%">
                                                                        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="110%" ForeColor="#00802B" Text="Save Type"></asp:Label>
                                                                    </td>
                                                                    <td colspan="2" style="text-align: left; width: 20%">
                                                                         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                             <ContentTemplate>
                                                                                 <asp:DropDownList ID="drplSaveType" runat="server" EnableTheming="True" Font-Size="110%" ForeColor="Black" Width="100%">
                                                                                     <asp:ListItem Value="5">Production</asp:ListItem>
                                                                                     <asp:ListItem Value="all">Pilot</asp:ListItem>
                                                                                 </asp:DropDownList>
                                                                             </ContentTemplate>
                                                                         </asp:UpdatePanel>
                                                                    </td>
                                                               ...
                                                               <tr style="height: 10%">
                                                                        ...
                                                                        <td style="text-align: left; width: 20%">
                                                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="drplName" runat="server" EnableTheming="True" Font-Size="110%" ForeColor="Black"  Width="100%">
                                                                                    </asp:DropDownList>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </td>
